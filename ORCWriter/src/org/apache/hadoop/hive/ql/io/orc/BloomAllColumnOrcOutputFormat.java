...
public class BloomAllColumnOrcOutputFormat extends
    FileOutputFormat<NullWritable, OrcSerdeRow> {
	
	static TaskAttemptContext globalContext=null;
  ...
  extends RecordWriter<NullWritable, OrcSerdeRow> {
    ...
    public void write(NullWritable key, OrcSerdeRow row)
      ...
      if (writer == null) {
        ...
        // added by ak
       System.out.println(globalContext.getConfiguration().get("hello"));
        options.bloomFilterColumns("*");
  ...
  public RecordWriter getRecordWriter(TaskAttemptContext context)
   ...
   Configuration configs = shims.getConfiguration(context);
   Iterator<Entry<String, String>> it = configs.iterator();
//   while (it.hasNext()) {
//	 Entry<String, String> entries = ((Map.Entry<java.lang.String, java.lang.String>) it.next());
//	 System.out.println(entries.getKey()+" "+entries.getValue());
//	 
//}
    return new
        OrcRecordWriter(file, OrcFile.writerOptions(configs));
  }
